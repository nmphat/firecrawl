...
describe("lockCredits", () => {
  it("returns unavailable when autumnClient is null", async () => {
  ...
  it("returns unavailable for preview teams", async () => {
    const svc = makeService();
  ...
  it("returns unavailable when the Autumn check throws", async () => {
